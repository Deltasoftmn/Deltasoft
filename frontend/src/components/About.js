...
const TEAM_DETAILED = [
  ...
  { name: 'С.НАНДИНХУУ', title: 'Ерөнхий инженер', profession: 'ІТ инженер', jobs: ['2023-оноос: "Дельтасофт" ХХК', '2019-2023: NUBIA /Шинэ нисэх буудал/', '2010-2019: Чингис хаан ОУНБ', '2005-2007: USI программын компани'], years: '20+' },
